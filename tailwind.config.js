...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'slide-in': "slide-in var(--animation-duration) linear",
        'appear-left-logo': "appear-left-logo var(--animation-duration) linear",
        'appear-vantage-logo': "appear-vantage-logo var(--animation-duration) linear",
        'reduce-height': "full-size-to-logo var(--animation-duration) linear",
        'fade-in': "content-appear var(--animation-duration) linear",
